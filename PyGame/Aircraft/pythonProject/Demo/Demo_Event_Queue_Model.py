...
import pygame
from pygame.constants import USEREVENT, K_SPACE, MOUSEBUTTONDOWN
        ...
        for event in pygame.event.get():
            if event.type == QUIT:
                ...
                if event.key == K_q:
                    ...
                    my_event = pygame.event.Event(MY_EVENT1, attri1="attribute1", attri2="myattribute2")
                ...
                additional_info = "my event1 is recevied"
