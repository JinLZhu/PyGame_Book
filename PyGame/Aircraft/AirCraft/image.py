...
class Image:
    ...
    small_enemies_name = ["enemy1", "enemy_down1", "enemy1_down2", "enemy1_down3", "enemy1_down4"]
    mid_enemies_name = ["enemy2", "enemy2_hit", "enemy2_down1", "enemy2_down2", "enemy_down3", "enemy_down4"]
